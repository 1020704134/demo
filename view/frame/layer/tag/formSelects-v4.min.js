...
})(typeof layui == "undefined" ? null: layui, window,
function() {
    var t = "4.0.0.0910",
    v = "xm-select",
    m = "xm-select-parent",
    ...
    o.prototype.init = function(e) {
        ...
        Q(e ? e: "select[" + v + "]").each(function(e, t) {
            ...
            if (s.config.isSearch) {
                ...
                Y[i]);
                Q(document).on("input", "div." + m + '[FS_ID="' + i + '"] .' + y,
                function(e) {
    ...
    o.prototype.triggerSearch = function(e, i) {
        var a = this; (e ? [e] : Q("." + P).toArray()).forEach(function(e, t) {
            e = Q(e);
    ...
    o.prototype.one = function(e) {
        var C = this;
        Q(e ? e: document).off("click", "." + I).on("click", "." + I,
        function(e) {
            var t = Q(e.target),
        ...
        Q(e ? e: document).off("click", "dl." + F).on("click", "dl." + F,
        function(e) {
            var t = Q(e.target);
    ...
    o.prototype.handlerLabel = function(e, t, n, i, a) {
        ...
        this.commonHandler(e, r); ! a && d && d instanceof Function && d(e, o.concat([]), l, n, t && t.hasClass(E))
    };
    ...
    o.prototype.changeShow = function(e, t) {
        ...
        if (t != i) {
            ...
            var l = q[a].config.closed || z.closed[a]; ! t && l && l instanceof Function && l(a)
        }
    };
    ...
    o.prototype.onreset = function() {
        Q(document).on("click", "[type=reset]",
        function(e) {
    ...
    u.prototype.config = function(e, n, t) {
        ...
        if (n && (typeof n === "undefined" ? "undefined": _typeof(n)) == "object") {
            ...
            e ? (Y[e] = Q.extend(true, {},
            Y[e] || X, n), !K.check(e) && this.render(e), q[e] && n.direction && (q[e].config.direction = n.direction), q[e] && n.clearInput && (q[e].config.clearInput = true), n.searchUrl && q[e] && K.triggerSearch(Q("." + m + ' dl[xid="' + e + '"]').parents("." + P), true)) : (Q.extend(true, X, n), Q.each(Y,
            function(e, t) {
                Q.extend(true, t, n)
            }))
        }
