                            ...
                            , success: function (layero, index) {
                                layui.use('upload', function (upload) {
                                    ...
                                    upload.render({
                                        ...
                                        , field: uploadImage.field
                                        , before: function (obj) {
                                            loding = layer.msg('文件上传中,请稍等哦111', { icon: 16, shade: 0.3, time: 0 });
                                        }
                                        , done: function (res, input, upload) {
                                            layer.close(loding);
                                            if (res.code == 0) {
                                    ...
                                    upload.render({
                                        ...
                                        , before: function (obj) {
                                            loding = layer.msg('文件上传中,请稍等哦11', { icon: 16, shade: 0.3, time: 0 });
                                        }
                                        , done: function (res, input, upload) {
                                            layer.close(loding);
                                            if (res.code == 0) {
                                ...
                                , success: function (layero, index) {
                                    layui.use('upload', function (upload) {
                                        ...
                                        upload.render({
                                            ...
                                            , field: uploadImage.field
                                            , before: function (obj) {
                                                loding = layer.msg('文件上传中,请稍等哦12', { icon: 16, shade: 0.3, time: 0 });
                                            }
                                            , done: function (res, input, upload) {
                                                layer.close(loding);
                                                if (res.code == 0) {
